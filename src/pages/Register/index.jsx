...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      axios
      .post('http://localhost:3000/user', { ...data, password: passwordValidated})
      .then((response) => {
  ...
  return (
    <AuthLayout title="Halo, Pewpeople!" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. In euismod ipsum et dui rhoncus auctor.">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <InputFormAuth title="Perusahaan" value={data.perusahaan} name="perusahaan" type="text" onchange={(e) => changeHandler(e)} />
        <InputFormAuth title="Jabatan" value={data.jabatan} name="jabatan" type="text" onchange={(e) => changeHandler(e)} />
        <InputFormAuth title="No Handphone" value={data.phone_number} name="phone_number" type="number" onchange={(e) => changeHandler(e)} />
